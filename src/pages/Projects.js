            ...
            <div className="m-page grey-text text-lighten-4">
                ...
                <div className="row">
                    <div id="project-board" className="col l8 s12 p-project-board border left-align">
                        ...
                        <div><div className="p-head">Description: </div><div className="i-b" id="p-description">This app fetches the lyrics, album art and album info of track stored offline.</div></div>
                    </div>
